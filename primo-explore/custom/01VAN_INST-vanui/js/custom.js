...
app.component('prmActionListAfter', {
	...
	template: `<custom-action name="text_me"
                            label="{{$ctrl.getLinkText()}}"
                            index=0
                            icon="ic_smartphone_24px"
                            icon-set="hardware"
                            link="{$ctrl.getLinkBase()}call={{$ctrl.getCall()}}&location={{$ctrl.getLibrary()}}&title={{$ctrl.getTitle()}}" />`
...
app.controller('textMePrimoController', ['textMePrimoConfig', function () {
